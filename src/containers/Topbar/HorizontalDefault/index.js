...
const HorizontalDefault = () => {
  ...
  return <div className="gx-header-horizontal">
      ...
      <div className="gx-container">
        <div className="gx-header-horizontal-main-flex">
          ...
          <Link to="/" className="gx-d-none gx-d-lg-block gx-pointer gx-mr-xs-5 gx-logo">
            <img alt="" src={`${env.PUBLIC_URL}/assets/images/PANACEA_LOGO.png`} /></Link>
          ...
          <ul className="gx-header-notifications gx-ml-auto">
            <li className="gx-notify gx-notify-search gx-d-inline-block gx-d-lg-none">
              <Popover overlayClassName="gx-popover-horizantal" placement="bottomRight" content={<div className="gx-d-flex">
                <Dropdown overlay={menu}>
                  <Button>
                    Category <Icon type="down" />
                  </Button>
                </Dropdown>
                <SearchBox styleName="gx-popover-search-bar" placeholder="Search in app..." onChange={updateSearchChatUser} value={searchText} />
              </div>} trigger="click">
