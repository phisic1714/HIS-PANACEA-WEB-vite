...
// import th from 'antd/es/locale/th_TH';
  // const localeDay = JSON.parse(JSON.stringify(th));
  // const dayjsLang = { ...localeDay.Calendar.lang };
  // dayjsLang.yearFormat = 'YYYY';
...
moment.prototype.format = function (format) {
  const result = format?.replace('BBBB', this._d.getFullYear())
  if(format)
...
export const ThaiDatePicker = generatePicker(momentConfig)
